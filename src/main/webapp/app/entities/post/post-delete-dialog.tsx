...
export const PostDeleteDialog = (props: IPostDeleteDialogProps) => {
  ...
  return (
    <Modal isOpen toggle={handleClose}>
      ...
      <ModalBody id="socialNetworkBackendApp.post.delete.question">
        <Translate contentKey="socialNetworkBackendApp.post.delete.question" interpolate={{ id: postEntity.id }}>
