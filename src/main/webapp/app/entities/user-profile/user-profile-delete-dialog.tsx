...
export const UserProfileDeleteDialog = (props: IUserProfileDeleteDialogProps) => {
  ...
  return (
    <Modal isOpen toggle={handleClose}>
      ...
      <ModalBody id="socialNetworkBackendApp.userProfile.delete.question">
        <Translate contentKey="socialNetworkBackendApp.userProfile.delete.question" interpolate={{ id: userProfileEntity.id }}>
